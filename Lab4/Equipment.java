...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        if (otherEq.getCount() == count && otherEq.getName().equals(name) && otherEq.getTotalWeight() == totalWeight
        		&& otherEq.getTotalPrice() == totalPrice && otherEq.getDescription().equals(description)) {
        	return true;
        }
        else {
        	return false;
